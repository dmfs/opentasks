...
public final class TaskBindings implements Bindings
{
    ...
    {
        mDelegate = new SingletonBindings("$task", new SuffixBindings(contentSet, model));
    }
    ...
    private static final class SuffixBindings implements Bindings
    {
        ...
        private SuffixBindings(ContentSet contentSet, Model model)
        {
