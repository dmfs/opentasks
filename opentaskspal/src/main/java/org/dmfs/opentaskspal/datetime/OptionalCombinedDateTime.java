...
import org.dmfs.opentaskspal.readdata.utils.LongBinaryBoolean;
...
/**
 * {@link Optional} {@link DateTime} value for a task composed from the 3 related fields' values (timestamp, timezone, all-day)
...
public final class OptionalCombinedDateTime extends DelegatingOptional<DateTime>
{
    ...
    public OptionalCombinedDateTime(@NonNull DateTimeFields fields)
    {
        this(new NullSafe<>(fields.timestamp()),
                ...
                new LongBinaryBoolean(fields.isAllDay()));
    }
